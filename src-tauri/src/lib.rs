...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::save_specialist,
            commands::delete_specialist,
            commands::run_specialist,
            commands::list_available_tools,
            commands::list_specialist_runs,
            ...
            commands::list_session_allowed_dirs,
            commands::revoke_session_dir,
            ...
            commands::recover_pathway_db,
            commands::get_memorabilia_mcp_status,
            commands::set_memorabilia_enabled,
            commands::get_memorabilia_items,
            commands::get_memorabilia_stats,
            commands::delete_memorabilia_item,
            commands::set_memorabilia_session_paused,
            commands::recover_memorabilia_db,
